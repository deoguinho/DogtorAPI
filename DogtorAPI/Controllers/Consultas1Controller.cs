...
namespace DogtorAPI.Controllers
{
    ...
    [ApiController]
    public class Consultas1Controller : ControllerBase
    {
        private readonly DogtorAPIContext _context;

        public Consultas1Controller(DogtorAPIContext context)
        {
            _context = context;
        }
